...
const Register = () => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center p-4 bg-background relative overflow-hidden">
            ...
            <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-primary-start/20 rounded-full blur-[120px] pointer-events-none"></div>
            <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-primary-end/20 rounded-full blur-[120px] pointer-events-none"></div>
            ...
            <div className="w-full max-w-md glass-card rounded-3xl p-10 space-y-8 relative z-10">
                ...
                <div className="flex flex-col items-center justify-center space-y-4">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-400 mt-2 text-sm">Join Nexus AI to build your projects</p>
                    </div>
                </div>
                ...
                <p className="text-center text-sm text-gray-400">
                    ...
                    <Link to="/login" className="text-primary-end font-semibold hover:text-white transition-colors">
                        Log in
                    </Link>
                </p>
            </div>
